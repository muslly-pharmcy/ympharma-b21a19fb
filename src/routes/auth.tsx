...
import { Loader2, Camera, Upload, X, Eye, EyeOff } from 'lucide-react'
...
export const Route = createFileRoute('/auth')({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'أنشئ حسابك في صيدلية المصلي لحفظ طلباتك ومتابعة حالتها بأمان.',
      },
...
function safeRedirect(raw?: string): string {
  ...
  if (/[\s\p{Cc}]/u.test(raw)) return DEFAULT_REDIRECT
            ...
            <label className="block">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 left-2 flex w-10 items-center justify-center text-muted-foreground hover:text-foreground"
                >
